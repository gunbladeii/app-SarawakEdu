...
insert into public.assessment_cycles (code, name, year, cycle_type, status, is_active)
values ('SPM-2026-PERCUBAAN', 'Percubaan SPM 2026', 2026, 'Percubaan', 'open', true)
...
create policy "admin manage assessment cycles"
  ...
  to authenticated
  using (public.current_app_role()::text = 'ppd_admin')
  with check (public.current_app_role()::text = 'ppd_admin');
